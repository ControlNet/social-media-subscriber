...
__all__ = (
    ...
    "test_terminal_snapshot_status_is_distinct_and_never_downloads",
    "test_unknown_snapshot_status_is_terminal_schema_failure",
)

test_person_identity_uses_exact_sync_scrape_contract = (
    errors.test_person_identity_uses_exact_sync_scrape_contract
)
test_company_posts_follow_owned_snapshot_to_ready_download = (
...
test_company_identity_uses_company_dataset = (
    requests.test_company_identity_uses_company_dataset
)
test_retryable_statuses_use_exact_bounded_backoff = (
...
test_unknown_snapshot_status_is_terminal_schema_failure = (
    errors.test_unknown_snapshot_status_is_terminal_schema_failure
)
test_terminal_snapshot_status_is_distinct_and_never_downloads = (
    errors.test_terminal_snapshot_status_is_distinct_and_never_downloads
)
test_malformed_json_is_a_sanitized_schema_failure = (
    errors.test_malformed_json_is_a_sanitized_schema_failure
)
test_include_error_record_is_input_failure_not_identity = (
    errors.test_include_error_record_is_input_failure_not_identity
)
test_snapshot_poll_failure_retains_accepted_ownership = (
